      ...
      {isEditing && editForm && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200 border border-gray-200 dark:border-gray-700">
            <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between gap-4 bg-gray-50 dark:bg-gray-800">
              <div className="flex items-center gap-4">
                ...
                <button
                  type="button"
                  onClick={() => alert("⚠️ تنويه هام:\nهذه الشاشة مخصصة لإدارة الواجهة الأمامية (Landing Page) فقط.\n\nلإدارة العملاء وإعدادات النظام:\n1. أغلق هذه النافذة.\n2. اضغط على زر 'تحدث مع المساعد الذكي'.\n3. في شاشة تسجيل الدخول، اضغط على شعار (Modern Soft) بالأعلى 10 مرات متتالية.\n4. ستفتح لك لوحة التحكم الكاملة.")}
                  className="hidden md:block text-xs bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 px-3 py-1.5 rounded-lg font-bold hover:bg-blue-100 dark:hover:bg-blue-900/40 transition"
                >
                  أبحث عن إضافة العملاء؟
                </button>
              </div>
