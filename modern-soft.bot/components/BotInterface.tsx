            ...
            `;
                ...
                chatRef.current = ai.chats.create({
                    ...
                    **TROUBLESHOOTING & PROCEDURES:**
                    ...
                    - **Accuracy**: Do not guess. If a shortcut is F12, say F12. If a menu is named [المخازن], say [المخازن]. Do not invent menu names.

                    **INTERACTION RULES:** 
                    - **Initial Greeting**: Ask for client details (Name, Pharmacy Name) if not provided.
